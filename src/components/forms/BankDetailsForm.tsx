...
const BankDetailsForm: React.FC<BankDetailsFormProps> = ({ bankDetails, setBankDetails }) => {
    ...
    return (
        <div className="">
            <h4 className="font-semibold text-black dark:text-white  pt-1 dark:border-strokedark text-lg">Bank Details (Optional)</h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    <label className="mb-1 block text-black dark:text-white text-sm font-medium">Bank Name</label>
                    <input
                        type="text"
                        name="bank_name"
                ...
                <div>
                    <label className="mb-1 block text-black dark:text-white text-sm font-medium">Account Number</label>
                    <input
                        type="text"
                        name="account_number"
                ...
                <div>
                    <label className="mb-1 block text-black dark:text-white text-sm font-medium">IFSC Code</label>
                    <input
                        type="text"
                        name="ifsc_code"
                        value={currentDetails.ifsc_code || ''}
                        onChange={handleBankChange}
                        className="w-full rounded border-[1.5px] border-stroke bg-transparent py-2 px-4 text-black outline-none transition focus:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white text-base"
                    />
                </div>
            </div>
        </div>
