          ...
          {filteredPackages.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredPackages.map((pkg: SubscriptionPackage) => {
                ...
                <div
                  key={pkg.id}
                  className={`border rounded-lg p-0 overflow-hidden transition-all hover:shadow-lg flex flex-col h-full ${
                    pkg.is_active
                       ...
                       <div className="flex items-center justify-center w-full text-primary text-xs font-medium animate-pulse">
                        ...
                        <>
                          <button
                            ...
                            className={`p-2 rounded-md hover:bg-white dark:hover:bg-boxdark shadow-sm border border-transparent hover:border-gray-200 dark:hover:border-gray-600 transition-all ${
                              disableToggle ? 'opacity-50 cursor-not-allowed text-gray-400' : pkg.is_active ? 'text-danger hover:text-danger' : 'text-success hover:text-success'
                            }`}
                          ...
                          <div className="flex gap-2 ml-auto">
                              ...
                              <button
                                ...
                                className={`p-2 rounded-md hover:bg-white dark:hover:bg-boxdark border border-transparent hover:border-gray-200 dark:hover:border-gray-600 transition-all ${
                                  disableDelete ? 'opacity-50 cursor-not-allowed text-gray-400' : 'text-gray-600 dark:text-gray-400 hover:text-danger'
                                }`}
